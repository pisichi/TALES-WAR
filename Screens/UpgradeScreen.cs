...
namespace Final_Assignment
{
    class UpgradeScreen : IGameScreen
    {
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(_font, "level  " + Singleton.Instance.level_s1, skill_button_poslist[0], Color.White, 0, new Vector2((skill_button_texturelist[0].Width - 100) / 2, (skill_button_texturelist[0].Height - 100) / 2) + _font.MeasureString("level") / 2, 1, SpriteEffects.None, 0);
            spriteBatch.DrawString(_font, "level  " + Singleton.Instance.level_s2, skill_button_poslist[1], Color.White, 0, new Vector2((skill_button_texturelist[1].Width - 100) / 2, (skill_button_texturelist[1].Height - 100) / 2) + _font.MeasureString("level") / 2, 1, SpriteEffects.None, 0);
            spriteBatch.DrawString(_font, "level  " + Singleton.Instance.level_s3, skill_button_poslist[2], Color.White, 0, new Vector2((skill_button_texturelist[2].Width - 100) / 2, (skill_button_texturelist[2].Height - 100) / 2) + _font.MeasureString("level") / 2, 1, SpriteEffects.None, 0);
